...
lengte<input name = "lengte" type = "number" value = "<?php if (isset($_POST['lengte'])) echo $_POST['lengte']; ?>" min = 50 max = 244>cm<br>
breedte<input name = "breedte" type = "number" value = "<?php if (isset($_POST['breedte'])) echo $_POST['breedte']; ?>"min = 50 max = 122>cm<br>
hoogte<input name = "hoogte" type = "number" value = "<?php if (isset($_POST['hoogte'])) echo $_POST['hoogte']; ?>"min = 40 max = 180>cm<br>
    ...
    <input name = "bouwen" type = "radio" value = "ongebouwd" <?php if(isset($_POST['bouwen']) && ($_POST['bouwen'] == 'ongebouwd')) echo 'checked="checked" ';?>>zelf bouwen<br>
...
echo "&euro;" . (round($prijs,2,PHP_ROUND_HALF_UP)) . "inclusief B.T.W.";
